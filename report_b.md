...
- 予測
  ...
  - ここでサポートベクトルの集合を<img src="https://latex.codecogs.com/gif.latex?S"/>とすると、任意の<img src="https://latex.codecogs.com/gif.latex?s\in&space;S" />について<img src="https://latex.codecogs.com/gif.latex?t_s(\boldsymbol{w}^T\phi(\boldsymbol{x}_s)+b)=1"/>が成り立つはずだが、<img src="https://latex.codecogs.com/gif.latex?b"/>の導出には全サポートベクトルについて計算した平均値を採用することが一般的<br/><img src="https://latex.codecogs.com/gif.latex?b=\frac{1}{|S|}\sum_{s\in&space;S}\left(\frac{1}{t_i}-\sum_{i=1}^na_it_ik(x_i,x_s)\right)"/>
...
- 結果のキャプション
  - 学習部分と予測部分
<img src="https://user-images.githubusercontent.com/34636490/118345194-e603bf00-b56d-11eb-93b6-5da9a159e05b.png" width=350 />
